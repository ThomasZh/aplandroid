...
public class UpdateClubTask extends TemplateTask {

	private ClubMasterInfo clubInfo;
	private String avatarImgPath;

	public UpdateClubTask(ClubMasterInfo clubInfo, String avatarImgPath) {
	...
	protected boolean justTodo() {
		...
		String json = null;
		Gson gson = new Gson();
		json = gson.toJson(clubInfo);
		ClubUpdateReq req = new ClubUpdateReq(json);

		try {

			ClubUpdateResp resp = (ClubUpdateResp) iClubApplication.send(req);
			if (resp == null)
